...
while time<time_final
   ...
   %----------------------------------------------------------------------
    ...
    if min(Mweights_t)<1
        ...
        MARK                =    reseed2(MARK, asp, L, ney_t, nmy, ELEM2NODE_t, RHO_nodes, MUPHASE_nodes, H_activ_nodes, PHASES_t, NUMMELT_t, TIMEMELT_t);
   ...
   %  %----------------------------------------------------------------------
     ...
     scatter(MARK.NODES(1,MARK.NUMMELT==1),MARK.NODES(2,MARK.NUMMELT==1),'.r')
     scatter(MARK.NODES(1,MARK.NUMMELT==2),MARK.NODES(2,MARK.NUMMELT==2),'.b')
     scatter(MARK.NODES(1,MARK.NUMMELT==3),MARK.NODES(2,MARK.NUMMELT==3),'.g')
     scatter(MARK.NODES(1,MARK.NUMMELT>3),MARK.NODES(2,MARK.NUMMELT>3),'.k')
